...
void RBT_InsertNode(RBTNode** Tree,RBTNode* NewNode){
    ...
    RBT_RebulidAfterInsertNode(Tree,NewNode); 
}
...
void RBT_RebulidAfterInsert(RBTNode** Root, RBTNode* X){
...
RBTNode* RBT_RemoveNode(RBTNode** Root,ElementType Data){
    ...
    if(Removed->Color == BLACK)
        RBT_RebulidAfterRemove(Root,Successor);
    
    return Removed;
    
}
void RBT_RebuliderAfterRemove(RBTNode** Root, RBTNode* Successor){
